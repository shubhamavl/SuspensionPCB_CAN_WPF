...
namespace SuspensionPCB_CAN_WPF.Core
{
    ...
    {
        public int AveragedValue { get; set; }
    ...
    public static class CalibrationStatistics
    {
            ...
            CancellationToken cancellationToken = default)
        {
                   ...
                   !cancellationToken.IsCancellationRequested)
            {
                ...
                // Filter invalid readings (zero values only - allow negative for ADS1115)
                // Range validation: Internal ADC (0-8190), ADS1115 (-65536 to +65534)
                if (currentADC != 0 && currentADC >= -65536 && currentADC <= 65534)
                {
